...
public class displaymyadapter extends FirebaseRecyclerAdapter<model, displaymyadapter.myviewholder>
{



    public displaymyadapter(@NonNull FirebaseRecyclerOptions<model> options)
    {
        super(options);
    }
