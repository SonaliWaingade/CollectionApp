...
public class display2myadapter extends FirebaseRecyclerAdapter<model, display2myadapter.myviewholder>
{

    ArrayList<model> data;
    Context context;

    public display2myadapter(@NonNull FirebaseRecyclerOptions<model> options, Context context) {
        super(options);
        this.data = data;
        this.context = context;
    }

    public display2myadapter(@NonNull FirebaseRecyclerOptions<model> options)
    {
        super(options);
    }
    ...
    {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.displaysinglerow,parent,false);
