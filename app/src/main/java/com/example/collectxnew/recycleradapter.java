...
public class recycleradapter extends FirebaseRecyclerAdapter<recyclerview, recycleradapter.myviewholder>
{

    ArrayList<model> data;
    Context context;

    public recycleradapter(@NonNull FirebaseRecyclerOptions<recyclerview> options, ArrayList<model> data, Context context) {
        super(options);
        this.data = data;
        this.context = context;
    }

    public recycleradapter(@NonNull FirebaseRecyclerOptions<recyclerview> options)
    {
        super(options);
    }
    ...
    @Override
    protected void onBindViewHolder(@NonNull final myviewholder holder, final int position, @NonNull final recyclerview recyclerview)
    {
        holder.name.setText(recyclerview.getName());
